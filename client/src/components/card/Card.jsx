  ...
  return (
    ...
    <div className="card">
        <div className="card__left">
            <img src={process.env.PUBLIC_URL + `${listing.img}`} alt="" className='card__left--img'/>
            <div className="card__left--group">
                <div className="link1" onClick={()=> handleZoomOut(listing.img)}>
        ...
        <div className="card__right">
            ...
            <div className="middle">
                <div className="middle__title">
                    <Link to={`/listing/${listing.id}`} className="link">
...
{imgModal && (
    ...
    <div className="imageModal">
        <div className="container" ref={modalRef}>
            ...
            <img src={process.env.PUBLIC_URL + `${img}`} alt="" className="imgM" />
            </div>
